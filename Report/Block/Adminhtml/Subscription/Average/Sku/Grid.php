<?php
namespace Toppik\Report\Block\Adminhtml\Subscription\Average\Sku;
...
class Grid extends \Magento\Reports\Block\Adminhtml\Grid\AbstractGrid {
    ...
    public function getResourceCollectionName() {
        return 'Toppik\Report\Model\ResourceModel\Report\Subscription\Average\Sku\Collection';
    }
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn(
            'sum_subscriptions',
            [
                'header' => __('Subscription Total'),
                'index' => 'sum_subscriptions',
                'type' => 'text',
                'sortable' => false,
                'header_css_class' => 'col-orders',
                'column_css_class' => 'col-orders'
        ...
        $this->addColumn(
            ...
            [
                ...
                'type' => 'number',
                'sortable' => false,
                'renderer' => 'Toppik\Report\Block\Adminhtml\Widget\Grid\Column\Renderer\Subscription\Average\Sku\Active',
                'header_css_class' => 'col-orders',
                'column_css_class' => 'col-orders'
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                ...
                'type' => 'number',
                'sortable' => false,
                'renderer' => 'Toppik\Report\Block\Adminhtml\Widget\Grid\Column\Renderer\Subscription\Average\Sku\Cancelled',
                'header_css_class' => 'col-orders',
                'column_css_class' => 'col-orders'
            ]
        );
