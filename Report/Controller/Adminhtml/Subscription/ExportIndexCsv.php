...
class ExportIndexCsv extends \Magento\Reports\Controller\Adminhtml\Report\Sales {
    ...
    public function execute() {
        $fileName = 'toppikreport_subscription_index.csv';
        $grid = $this->_view->getLayout()->createBlock('Toppik\Report\Block\Adminhtml\Subscription\Index\Grid');
