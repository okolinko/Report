...
class ExportFutureCsv extends \Magento\Reports\Controller\Adminhtml\Report\Sales {
    ...
    public function execute() {
        $fileName = 'toppikreport_subscription_future.csv';
        $grid = $this->_view->getLayout()->createBlock('Toppik\Report\Block\Adminhtml\Subscription\Future\Grid');
