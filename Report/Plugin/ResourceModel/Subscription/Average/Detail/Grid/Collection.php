<?php
namespace Toppik\Report\Plugin\ResourceModel\Subscription\Average\Detail\Grid;

class Collection {
	
    public function afterSetMainTable(\Toppik\Report\Model\ResourceModel\Report\Subscription\Average\Detail\Collection $collection) {
        ...
        $collection->addFilterToMap('subscription_status', 'main_table.status');
