<?php
namespace Toppik\Report\Model\ResourceModel\Report\Subscription\Lifetime;
...
class Collection extends \Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult {
    ...
    protected $_fieldMap = [
        ...
        'campaign_description' => 'mod.campaign_description'
    ];
    ...
    protected function _initSelect() {
        ...
        $this->getSelect()
            ...
            ->joinLeft(array(
                ...
                'mod.order_id = sales_order.entity_id',
                array()
            )
            ->columns([
