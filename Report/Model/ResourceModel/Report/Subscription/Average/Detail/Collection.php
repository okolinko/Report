<?php
namespace Toppik\Report\Model\ResourceModel\Report\Subscription\Average\Detail;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection {
    ...
    public function __construct(
        ...
        $this->_init(
            'Toppik\Report\Model\Report\Subscription\Average',
            'Toppik\Report\Model\ResourceModel\Report\Subscription\Average'
        );
    ...
    protected function _initSelect() {
        ...
        $this->getSelect()
            ->columns(array(
                ...
                'subscription_last_order'       => 'order.increment_id',
                ...
                'duration_days'                 => new \Zend_Db_Expr('
                                                    TIMESTAMPDIFF(
                                                        DAY,
