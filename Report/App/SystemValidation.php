<?php
namespace Toppik\Report\App;

class SystemValidation implements \Magento\Framework\AppInterface {
    ...
    public function launch() {
		...
		$cron = $this->objectManager->get('Toppik\Report\Cron\SystemValidation');
		$cron->execute();
